...
namespace Server.Misc
{
	public class Titles
	{
				...
				case 6:
					{
						...
						{
							// TODO: verify
							title = "Victorious of the Sleeping Dragon";
						} 
						break;
					}
			}
			...
			if ( pm != null )
			{
				if ( pm.SuperChampionTiers[ 0 ] > 0 ) // player killed harrower at least one time
				{
					...
					switch ( count )
					{
						...
						case 7:
							title = "Champion of Evil";
							break; // TODO: verify system for harrower and 7 killed champions
					}
				}
				else
				{
		...
		public static string ComputeTitle( Mobile beholder, Mobile beheld )
		{
			...
			if ( pm != null && pm.ToggleMonstersTitles && championTitle != null )
			{
