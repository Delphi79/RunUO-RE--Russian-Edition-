...
namespace Server
{
	public class AOS
	{
		...
		public static void Configure()
		{
			...
			if ( !Enabled && Core.SE )
			{
				Console.WriteLine( "Warning: SE is enabled, but AoS is disabled.  Server defaulting to AoS enabled." );
			}
		...
		public static bool ArmorIgnore { get { return m_ArmorIgnore; } set { m_ArmorIgnore = value; } }

		private static bool m_ArmorPierce;

		public static bool ArmorPierce { get { return m_ArmorPierce; } set { m_ArmorPierce = value; } }
