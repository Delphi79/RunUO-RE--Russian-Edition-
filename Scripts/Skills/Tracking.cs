...
namespace Server.SkillHandlers
{
	...
	public class TrackWhoGump : Gump
	{
		...
		private static TrackTypeDelegate[] m_Delegates = new TrackTypeDelegate[] {new TrackTypeDelegate( IsAnimal ), new TrackTypeDelegate( IsMonster ), new TrackTypeDelegate( IsHumanNPC ), new TrackTypeDelegate( IsPlayer )};
		...
		public static void DisplayTo( bool success, Mobile from, int type )
		{
			...
			foreach ( Mobile m in from.GetMobilesInRange( range ) )
			{
				...
				{
					from.Tracking_Table[ m ] = (int) from.GetDistanceToSqrt( m.Location );
