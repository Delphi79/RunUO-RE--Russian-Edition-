...
{
	public class PolymorphGumpSE : Gump
	{
		...
		private static PolymorphEntry[] FirstPageEntries = new PolymorphEntry[] {new PolymorphEntry( 8401, 0xD0, 1015236, 15, 10 ), //Chicken
		...
		private static PolymorphEntry[] SecondPageEntries = new PolymorphEntry[] {new PolymorphEntry( 8424, 0x33, 1015246, 5, 10 ), //Slime
		...
		public PolymorphGumpSE( Mobile caster, Item scroll ) : base( 0, 0 )
		{
			m_Caster = caster;
			m_Scroll = scroll;
