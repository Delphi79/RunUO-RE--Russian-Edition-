...
namespace Server.Gumps
{
	...
	public class AdminGump : Gump
	{
		...
		private static string[] m_AccessLevelStrings = new string[] {"Player", "Counselor", "Game Master", "Seer", "Administrator"};
				...
				case AdminGumpPage.Information_Perf:
					{
						...
						AddLabel( 20, 200, LabelHue, "Incoming Traffic: " + FormatByteAmount( Core.Incoming ) );
						AddLabel( 20, 220, LabelHue, "Outgoing Traffic: " + FormatByteAmount( Core.Outgoing ) );

						StringBuilder sb = new StringBuilder();
						ArrayList pools = BufferPool.Pools;

						lock ( pools )
						{
							for ( int i = 0; i < pools.Count; ++i )
							{
								BufferPool pool = (BufferPool) pools[ i ];
						...
						AddLabel( 20, 250, LabelHue, "Buffer Pools:" );
						AddHtml( 20, 270, 380, 150, sb.ToString(), true, true );
