...
namespace Server.Spells.Seventh
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Gate Travel", "Vas Rel Por", SpellCircle.Seventh, 263, 9032, Reagent.BlackPearl, Reagent.MandrakeRoot, Reagent.SulfurousAsh );
