...
namespace Server.Spells.Seventh
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Mana Vampire", "Ort Sanct", SpellCircle.Seventh, 221, 9032, Reagent.BlackPearl, Reagent.Bloodmoss, Reagent.MandrakeRoot, Reagent.SpidersSilk );
