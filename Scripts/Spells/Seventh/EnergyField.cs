...
namespace Server.Spells.Seventh
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Energy Field", "In Sanct Grav", SpellCircle.Seventh, 221, 9022, false, Reagent.BlackPearl, Reagent.MandrakeRoot, Reagent.SpidersSilk, Reagent.SulfurousAsh );
