...
namespace Server.Spells.Second
{
	public class ProtectionSpell : Spell
	{
		...
		private static SpellInfo m_Info = new SpellInfo( "Protection", "Uus Sanct", SpellCircle.Second, 236, 9011, Reagent.Garlic, Reagent.Ginseng, Reagent.SulfurousAsh );
		...
		public static void Toggle( Mobile caster, Mobile target )
		{
			...
			if ( mods == null )
			{
				...
				mods = new object[2] {new ResistanceMod( ResistanceType.Physical, -15 + (int) (caster.Skills[ SkillName.Inscribe ].Value/20) ), new DefaultSkillMod( SkillName.MagicResist, true, -35 + (int) (caster.Skills[ SkillName.Inscribe ].Value/20) )};
