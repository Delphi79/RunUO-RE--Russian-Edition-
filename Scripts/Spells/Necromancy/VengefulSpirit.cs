...
namespace Server.Spells.Necromancy
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Vengeful Spirit", "Kal Xen Bal Beh", SpellCircle.Sixth, 203, 9031, Reagent.BatWing, Reagent.GraveDust, Reagent.PigIron );
