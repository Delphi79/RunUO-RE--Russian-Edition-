...
namespace Server.Spells.Necromancy
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Lich Form", "Rel Xen Corp Ort", SpellCircle.Sixth, 203, 9031, Reagent.GraveDust, Reagent.DaemonBlood, Reagent.NoxCrystal );
