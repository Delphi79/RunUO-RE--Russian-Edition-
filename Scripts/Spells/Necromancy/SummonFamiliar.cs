...
namespace Server.Spells.Necromancy
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Summon Familiar", "Kal Xen Bal", SpellCircle.Sixth, 203, 9031, Reagent.BatWing, Reagent.GraveDust, Reagent.DaemonBlood );
		...
		private static SummonFamiliarEntry[] m_Entries = new SummonFamiliarEntry[] {new SummonFamiliarEntry( typeof( HordeMinionFamiliar ), 1060146, 30.0, 30.0 ), // Horde Minion
