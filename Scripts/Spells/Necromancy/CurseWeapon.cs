...
namespace Server.Spells.Necromancy
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Curse Weapon", "An Sanct Gra Char", SpellCircle.First, 203, 9031, Reagent.PigIron );
		...
		public override void OnCast()
		{
			...
			else if ( CheckSequence() )
			{
				...
				TimeSpan duration = TimeSpan.FromSeconds( (Caster.Skills[ SkillName.SpiritSpeak ].Value/3.5) + 2.0 );
