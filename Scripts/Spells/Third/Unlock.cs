...
namespace Server.Spells.Third
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Unlock Spell", "Ex Por", SpellCircle.Third, 215, 9001, Reagent.Bloodmoss, Reagent.SulfurousAsh );
		...
		public void Target( LockableContainer targ )
		{
			...
			else if ( CheckSequence() )
			{
				...
				Effects.SendLocationParticles( EffectItem.Create( loc, targ.Map, EffectItem.DefaultDuration ), 0x376A, 9, 32, 5024 );
