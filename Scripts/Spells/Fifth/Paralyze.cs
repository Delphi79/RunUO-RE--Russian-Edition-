...
namespace Server.Spells.Fifth
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Paralyze", "An Ex Por", SpellCircle.Fifth, 218, 9012, Reagent.Garlic, Reagent.MandrakeRoot, Reagent.SpidersSilk );
		...
		public void Target( Mobile m )
		{
			...
			else if ( Core.AOS && (m.Frozen || m.Paralyzed || (m.Spell != null && m.Spell.IsCasting && ((Spell) m.Spell).BlocksMovement)) )
			{
