...
namespace Server.Spells.Fifth
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Poison Field", "In Nox Grav", SpellCircle.Fifth, 230, 9052, false, Reagent.BlackPearl, Reagent.Nightshade, Reagent.SpidersSilk );
		...
		private class InternalItem : Item
		{
			...
			public void ApplyPoisonTo( Mobile m )
			{
				...
				PlayerMobile c = m_Caster as PlayerMobile;

				if ( c != null && c.HonorOpponent != null && c.HonorOpponent == m )
				{
