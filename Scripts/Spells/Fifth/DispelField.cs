...
namespace Server.Spells.Fifth
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Dispel Field", "An Grav", SpellCircle.Fifth, 206, 9002, Reagent.BlackPearl, Reagent.SpidersSilk, Reagent.SulfurousAsh, Reagent.Garlic );
