...
namespace Server.Spells.Eighth
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Air Elemental", "Kal Vas Xen Hur", SpellCircle.Eighth, 269, 9010, false, Reagent.Bloodmoss, Reagent.MandrakeRoot, Reagent.SpidersSilk );
