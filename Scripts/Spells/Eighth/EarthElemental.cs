...
namespace Server.Spells.Eighth
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Earth Elemental", "Kal Vas Xen Ylem", SpellCircle.Eighth, 269, 9020, false, Reagent.Bloodmoss, Reagent.MandrakeRoot, Reagent.SpidersSilk );
