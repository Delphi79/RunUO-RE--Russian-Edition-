...
namespace Server.Spells.Sixth
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Mass Curse", "Vas Des Sanct", SpellCircle.Sixth, 218, 9031, false, Reagent.Garlic, Reagent.Nightshade, Reagent.MandrakeRoot, Reagent.SulfurousAsh );
