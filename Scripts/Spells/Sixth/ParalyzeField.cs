...
namespace Server.Spells.Sixth
{
	...
	{
		private static SpellInfo m_Info = new SpellInfo( "Paralyze Field", "In Ex Grav", SpellCircle.Sixth, 230, 9012, false, Reagent.BlackPearl, Reagent.Ginseng, Reagent.SpidersSilk );
