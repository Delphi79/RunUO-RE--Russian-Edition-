...
namespace Server.Multis
{
	public abstract class BaseHouse : BaseMulti
	{
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public Point3D BanLocation { get { return m_Region.GoLocation; } set { m_Region.GoLocation = new Point3D( m_Region.GoLocation.X + value.X, m_Region.GoLocation.Y + value.Y, m_Region.GoLocation.Z + value.Z ); } }
