...
namespace Server.Accounting
{
	public class Account : IAccount
	{
		...
		/// </summary>
		public HardwareInfo HardwareInfo { get { return m_HardwareInfo; } set { m_HardwareInfo = value; } }
		...
		/// </summary>
		public string[] IPRestrictions { get { return m_IPRestrictions; } set { m_IPRestrictions = value; } }

		/// <summary>
		/// List of IP addresses which have successfully logged into this account.
		/// </summary>
		public IPAddress[] LoginIPs { get { return m_LoginIPs; } set { m_LoginIPs = value; } }

		/// <summary>
		/// List of account comments. Type of contained objects is AccountComment.
		/// </summary>
		public ArrayList Comments { get { return m_Comments; } }

		/// <summary>
		/// List of account tags. Type of contained objects is AccountTag.
		/// </summary>
		public ArrayList Tags { get { return m_Tags; } }
		...
		/// </summary>
		public string PlainPassword { get { return m_PlainPassword; } set { m_PlainPassword = value; } }

		/// <summary>
		/// Account password. Hashed with MD5. May be null.
		/// </summary>
		public string CryptPassword { get { return m_CryptPassword; } set { m_CryptPassword = value; } }
		...
		public bool GetBanTags( out DateTime banTime, out TimeSpan banDuration )
		{
			...
			else if ( tagDuration != null )
			{
				try
				{
					banDuration = TimeSpan.Parse( tagDuration );
				}
				catch
				{
		...
		public bool HasAccess( NetState ns )
		{
			...
			try
			{
				ipAddress = ((IPEndPoint) ns.Socket.RemoteEndPoint).Address;
			} 
			catch
			{
				return false;
