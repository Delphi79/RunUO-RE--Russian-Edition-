...
namespace Server.Engines.Craft
{
	public class DefCartography : CraftSystem
	{
		...
		public override double GetChanceAtMin( CraftItem item )
		{
			...
			{
				return 0.175; // 17.5% for world map
			} 
		...
		{
			AddCraft( typeof( LocalMap ), 1044448, 1015230, 0.0, 75.1, typeof( BlankMap ), 1044449, 1, 1044450 );
			...
			AddCraft( typeof( WorldMap ), 1044448, 1015233, 50.0, 91.25, typeof( BlankMap ), 1044449, 1, 1044450 );
		}
	}
}