...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		private static Type[] m_TinkerColorables = new Type[] {typeof( ForkLeft ), typeof( ForkRight ), typeof( SpoonLeft ), typeof( SpoonRight ), typeof( KnifeLeft ), typeof( KnifeRight ), typeof( Plate ), typeof( Goblet ), typeof( PewterMug ), typeof( KeyRing ), typeof( Candelabra ), typeof( Scales ), typeof( IronKey ), typeof( Globe ), typeof( Spyglass ), typeof( Lantern ), typeof( HeatingStand )};
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( IronKey ), 1044050, 1024112, 20.0, 70.0, typeof( IronIngot ), 1044036, 3, 1044037 );
			...
			#region Traps
			// Dart Trap
			index = AddCraft( typeof( DartTrap ), 1044052, 1024396, 30.0, 80.0, typeof( IronIngot ), 1044036, 1, 1044037 );
			AddRes( index, typeof( Bolt ), 1044570, 1, 1044253 );

			// Poison Trap
			index = AddCraft( typeof( PoisonTrap ), 1044052, 1044593, 30.0, 80.0, typeof( IronIngot ), 1044036, 1, 1044037 );
			AddRes( index, typeof( BasePoisonPotion ), 1044571, 1, 1044253 );

			// Explosion Trap
			index = AddCraft( typeof( ExplosionTrap ), 1044052, 1044597, 55.0, 110.0, typeof( IronIngot ), 1044036, 1, 1044037 );
