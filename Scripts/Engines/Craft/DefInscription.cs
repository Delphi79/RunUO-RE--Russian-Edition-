...
namespace Server.Engines.Craft
{
	public class DefInscription : CraftSystem
	{
		...
		private Type[] m_RegTypes = new Type[] {typeof( BlackPearl ), typeof( Bloodmoss ), typeof( Garlic ), typeof( Ginseng ), typeof( MandrakeRoot ), typeof( Nightshade ), typeof( SulfurousAsh ), typeof( SpidersSilk )};
		...
		{
			int index = AddCraft( type, 1061677, 1060509 + spell, minSkill, minSkill + 50.0, regs[ 0 ], 1020000 + CraftItem.ItemIDOf( regs[ 0 ] ), 1, 501627 );
