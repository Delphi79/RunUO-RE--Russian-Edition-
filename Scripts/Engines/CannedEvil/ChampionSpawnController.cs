...
namespace Server.Engines.CannedEvil
{
	public class ChampionSpawnController : Item
	{
		...
		private SpawnRecord[] m_Dungeons = new SpawnRecord[] {new SpawnRecord( (int) ChampionSpawnType.UnholyTerror, 5178, 708, 20 ), new SpawnRecord( (int) ChampionSpawnType.VerminHorde, 5558, 823, 65 ), new SpawnRecord( (int) ChampionSpawnType.ColdBlood, 5259, 837, 64 ), new SpawnRecord( (int) ChampionSpawnType.Abyss, 5813, 1350, 1 ), new SpawnRecord( (int) ChampionSpawnType.Arachnid, 5188, 1607, 20 ),};

		private SpawnRecord[] m_LostLands = new SpawnRecord[] {new SpawnRecord( 0xff, 5636, 2916, 37 ), // Desert
		...
		private SpawnRecord[] m_Ilshenar = new SpawnRecord[] {new SpawnRecord( 0xff, 383, 329, -30 ), // Valor
			new SpawnRecord( 0xff, 462, 926, -67 ), // Humility
			new SpawnRecord( (int) ChampionSpawnType.ForestLord, 1645, 1108, 8 ), // Spirituality
		};

		private SpawnRecord[] m_Tokuno = new SpawnRecord[] {new SpawnRecord( (int) ChampionSpawnType.SleepingDragon, 947, 436, 29 ), // Isamu Jima
		};
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public TimeSpan RandomizeDelay { get { return m_RandomizeDelay; } set { m_RandomizeDelay = value; } }
