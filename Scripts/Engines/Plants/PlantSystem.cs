...
namespace Server.Engines.Plants
{
	...
	public class PlantSystem
	{
		...
		public bool FertileDirt { get { return m_FertileDirt; } set { m_FertileDirt = value; } }

		public DateTime NextGrowth { get { return m_NextGrowth; } }

		public PlantGrowthIndicator GrowthIndicator { get { return m_GrowthIndicator; } }
		...
		public int MaxHits { get { return 10 + (int) m_Plant.PlantStatus*2; } }
		...
		public bool HasMaladies { get { return Infestation > 0 || Fungus > 0 || Poison > 0 || Disease > 0 || Water != 2; } }

		public bool PollenProducing { get { return m_Plant.IsCrossable && m_Plant.PlantStatus >= PlantStatus.FullGrownPlant; } }

		public bool Pollinated { get { return m_Pollinated; } set { m_Pollinated = value; } }
