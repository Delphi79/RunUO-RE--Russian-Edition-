	...
	public class SmallBODGump : Gump
	{
		...
		public SmallBODGump( Mobile from, SmallBOD deed ) : base( 25, 25 )
		{
			...
			if ( deed.RequireExceptional || deed.Material != BulkMaterialType.None )
			{
				...
				AddHtmlLocalized( 75, 120, 200, 20, 1045140, 0x7FFF, false, false );
			} 

			if ( deed.RequireExceptional )
			{
				// All items must be exceptional.
				AddHtmlLocalized( 75, 144, 300, 20, 1045141, 0x7FFF, false, false );
			} 

			if ( deed.Material != BulkMaterialType.None )
			{
				// All items must be made with x material.
				AddHtmlLocalized( 75, deed.RequireExceptional ? 168 : 144, 300, 20, GetMaterialNumberFor( deed.Material ), 0x7FFF, false, false );
			} 
