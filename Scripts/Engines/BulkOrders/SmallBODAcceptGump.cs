		...
		public SmallBODAcceptGump( Mobile from, SmallBOD deed ) : base( 50, 50 )
		{
			...
			if ( deed.RequireExceptional || deed.Material != BulkMaterialType.None )
			{
				...
				if ( deed.RequireExceptional )
				{
					...
					AddHtmlLocalized( 40, 168, 350, 20, 1045141, 0x7FFF, false, false );
				}

				if ( deed.Material != BulkMaterialType.None )
				{
					// All items must be made with x material.
					AddHtmlLocalized( 40, deed.RequireExceptional ? 192 : 168, 350, 20, GetMaterialNumberFor( deed.Material ), 0x7FFF, false, false );
				} 
			}
