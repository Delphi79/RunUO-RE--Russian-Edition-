		...
		public LargeTailorBOD()
		{
			...
			switch ( Utility.Random( 17 ) )
			{
				...
				case 7:
					...
					break;
				case 8:
					entries = LargeBulkEntry.ConvertEntries( this, LargeBulkEntry.NinjaSet );
					useMaterials = true;
					break;
				case 9:
					...
					break;
				case 10:
					entries = LargeBulkEntry.ConvertEntries( this, LargeBulkEntry.SELeatherSet );
					useMaterials = true;
					break;
				case 11:
					...
					break;
				case 12:
					entries = LargeBulkEntry.ConvertEntries( this, LargeBulkEntry.StuddedSESet );
					useMaterials = true;
					break;
				case 13:
