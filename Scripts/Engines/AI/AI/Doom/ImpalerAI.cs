...
namespace Server.Mobiles
{
	public class ImpalerAI : BaseAI
	{
		...
		public ImpalerAI( BaseCreature m ) : base( m )
		{
		...
		private void TryTeleport()
		{
			...
			m_Mobile.DebugSay( "i want to teleport to {0}?", m_Mobile.Combatant.Name );
			if ( ++blockcounter > 10 )
			{
				blockcounter = 0;
				if ( Utility.RandomDouble() <= TeleportChance )
				{
					m_Mobile.DebugSay( "i want teleporting to {0}", m_Mobile.Combatant.Name );
		...
		public override bool DoActionCombat()
		{
			...
			if ( m_Mobile.Hits < m_Mobile.HitsMax*20/100 )
			{
				...
				if ( flee )
				{
					m_Mobile.DebugSay( "i must escape from {0}", c.Name );
			...
			{
				m_Mobile.DebugSay( "check for hiders...", c.Name );
		...
		public override bool DoActionGuard()
		{
			...
			{
				m_Mobile.DebugSay( "bad! {0} ...", m_Mobile.FocusMob.Name );
				m_Mobile.Combatant = m_Mobile.FocusMob;
				Action = ActionType.Combat;
			}
			else
		...
		public override bool DoActionFlee()
		{
			...
			{
				m_Mobile.DebugSay( "{0} you are bastard", m_Mobile.FocusMob.Name );
