...
{
	public class DemonKnightAI : BaseAI
	{
		private const double ChanceToDetectHidden = 0.10;

		private DateTime m_NextCastTime;

		public DemonKnightAI( BaseCreature m ) : base( m )
		{
		}
		...
		{
			if ( (m.Location.X >= 427) && (m.Location.X <= 429) && (m.Location.Y >= 316) && (m.Location.Y <= 329) && (m.Location.Z >= -1) && (m.Location.Z <= 3) )
			{
		...
		{
			if ( !
				(((m_Mobile.Location.X >= 424) && (m_Mobile.Location.X <= 425) && (m_Mobile.Location.Y >= 325) && (m_Mobile.Location.Y <= 334) && (m_Mobile.Location.Z >= -2) && (m_Mobile.Location.Z <= 0)) || ((m_Mobile.Location.X >= 432) && (m_Mobile.Location.X <= 433) && (m_Mobile.Location.Y >= 323) && (m_Mobile.Location.Y <= 334) && (m_Mobile.Location.Z >= -3) && (m_Mobile.Location.Z <= 0))) )
			{
