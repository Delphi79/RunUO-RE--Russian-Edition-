...
namespace Server.Mobiles
{
	...
	{
		public ThrowingTessenSE( Mobile from ) : base( from, FanDancer.AbilityRange, typeof( Tessen ) )
		{
		}
	...
	{
		public ThrowingDaggerSE( Mobile from ) : base( from, 12, typeof( ThrowingDagger ) )
		{
		}
	...
	{
		public ThrowingSnowballSE( Mobile from ) : base( from, LadyOfTheSnow.AbilityRange, null )
		{
		}
	...
	{
		public PoisonSpitSE( Mobile from ) : base( from, DeathWatchBeetle.AbilityRange, null )
		{
		}
	...
	{
		public ThrowingShurikenSE( Mobile from ) : base( from, EliteNinja.AbilityRange, null )
		{
		}
