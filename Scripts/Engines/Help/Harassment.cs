...
namespace Server.Engines.Help
{
	public class SelectComplaintTargetsGump : Gump
	{
		...
		public SelectComplaintTargetsGump( string m_text, PageType type ) : base( 0, 0 )
		{
			text = m_text;
	...
	public class TargetInvolvedPlayersGump : Gump
	{
		...
		public TargetInvolvedPlayersGump( string m_text, PageType type, string m_first, string m_second, string m_third ) : base( 0, 0 )
		{
			text = m_text;
	...
	public class SelectTarget : Target
	{
		...
		public SelectTarget( string m_text, PageType type, string m_first, string m_second, string m_third, int m_number ) : base( 8, false, TargetFlags.None )
		{
			number = m_number;
			first = m_first;
			second = m_second;
	...
	public class TypeNamesOfInvolvedPlayersGump : Gump
	{
		...
		public TypeNamesOfInvolvedPlayersGump( string m_text, PageType type, string m_first, string m_second, string m_third ) : base( 0, 0 )
		{
			text = m_text;
	...
	public class SelectNamesOfInvolvedPlayersFromListGump : Gump
	{
		...
		public SelectNamesOfInvolvedPlayersFromListGump( string m_text, PageType type ) : base( 0, 0 )
		{
			text = m_text;
