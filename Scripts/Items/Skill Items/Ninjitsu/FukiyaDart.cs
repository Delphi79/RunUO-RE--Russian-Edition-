...
namespace Server.Items
{
	...
	public class FukiyaDart : Item, IUsesRemaining, ICraftable
	{
		...
		[Constructable]
		public FukiyaDart() : this( 1 )
		{
		}

		public FukiyaDart( int uses ) : base( 0x2806 )
		{
			m_UsesRemaining = uses;
		}

		public FukiyaDart( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_Quality == DartQuality.Exceptional )
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				...
				case 0:
				{
					...
					m_Quality = (DartQuality)reader.ReadEncodedInt();
