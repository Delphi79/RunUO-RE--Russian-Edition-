...
namespace Server.Items
{
	public class Bowl : StealableArtifact
	{
		...
		[Constructable]
		public Bowl() : base( 0x24DE )
		{
		}

		public Bowl( Serial serial ) : base( serial )
		{
		}
	...
	public class BowlsLight : StealableArtifact
	{
		...
		[Constructable]
		public BowlsLight() : base( 0x24DF )
		{
		}

		public BowlsLight( Serial serial ) : base( serial )
		{
		}
	...
	public class BowlsDark : StealableArtifact
	{
		...
		[Constructable]
		public BowlsDark() : base( 0x24E0 )
		{
		}

		public BowlsDark( Serial serial ) : base( serial )
		{
		}
