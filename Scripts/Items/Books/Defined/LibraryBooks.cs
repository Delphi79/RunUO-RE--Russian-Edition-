...
namespace Server.Items
{
	...
	{
		[Constructable]
		public GrammarOfOrcish() : base( Utility.Random( 0xFEF, 2 ), "A Grammar of Orcish", "Yorick of Yew", 23, false )
		{
	...
	{
		[Constructable]
		public CallToAnarchy() : base( Utility.Random( 0xFEF, 2 ), "A Politic Call to Anarchy", "Lord Blackthorn", 15, false )
		{
	...
	{
		[Constructable]
		public ArmsAndWeaponsPrimer() : base( Utility.Random( 0xFEF, 2 ), "A Primer on Arms and Weapons", "Martin", 16, false )
		{
	...
	{
		[Constructable]
		public SongOfSamlethe() : base( Utility.Random( 0xFEF, 2 ), "A Song of Samlethe", "Sandra", 6, false )
		{
	...
	{
		[Constructable]
		public TaleOfThreeTribes() : base( Utility.Random( 0xFEF, 2 ), "A Tale of Three Tribes", "Janet, Scribe", 10, false )
		{
	...
	{
		[Constructable]
		public GuideToGuilds() : base( Utility.Random( 0xFEF, 2 ), "Beltran's Guide to Guilds", "Beltran", 18, false )
		{
	...
	{
		[Constructable]
		public BirdsOfBritannia() : base( Utility.Random( 0xFEF, 2 ), "Birds of Britannia", "Thom the Heathen", 28, false )
		{
	...
	{
		[Constructable]
		public BritannianFlora() : base( Utility.Random( 0xFEF, 2 ), "Britannian Flora: A Casual Guide", "Herbert the Lost", 18, false )
		{
	...
	{
		[Constructable]
		public ChildrenTalesVol2() : base( Utility.Random( 0xFEF, 2 ), "Classic Children's Tales, Volume 2", "Guilhem, Editor", 10, false )
		{
	...
	{
		[Constructable]
		public TalesOfVesperVol1() : base( Utility.Random( 0xFEF, 2 ), "Classic Tales of Vesper, Volume 1", "Clarke's Printery", 21, false )
		{
	...
	{
		[Constructable]
		public DeceitDungeonOfHorror() : base( Utility.Random( 0xFEF, 2 ), "Deceit: A Dungeon of Horrors", "Mercenary Justin", 12, false )
		{
	...
	{
		[Constructable]
		public DimensionalTravel() : base( Utility.Random( 0xFEF, 2 ), "Dimensional Travel, a Monograph", "Dryus Doost, Mage", 18, false )
		{
	...
	{
		[Constructable]
		public EthicalHedonism() : base( Utility.Random( 0xFEF, 2 ), "Ethical Hedonism: An Introduction", "Richard Garriott", 25, false )
		{
	...
	{
		[Constructable]
		public MyStory() : base( Utility.Random( 0xFEF, 2 ), "My Story", "Sherry the Mouse", 49, false )
		{
	...
	{
		[Constructable]
		public DiversityOfOurLand() : base( Utility.Random( 0xFEF, 2 ), "On the Diversity of Our Land", "Lord Blackthorn", 15, false )
		{
	...
	{
		[Constructable]
		public QuestOfVirtues() : base( Utility.Random( 0xFEF, 2 ), "Quest of the Virtues", "Autenil", 38, false )
		{
	...
	{
		[Constructable]
		public RegardingLlamas() : base( Utility.Random( 0xFEF, 2 ), "Regarding Llamas", "Simon", 4, false )
		{
	...
	{
		[Constructable]
		public TalkingToWisps() : base( Utility.Random( 0xFEF, 2 ), "Talking to Wisps", "Yorick ofMoonglow", 9, false )
		{
	...
	{
		[Constructable]
		public TamingDragons() : base( Utility.Random( 0xFEF, 2 ), "Taming Dragons", "Wyrd Beastmaster", 8, false )
		{
	...
	{
		[Constructable]
		public BoldStranger() : base( Utility.Random( 0xFEF, 2 ), "The Bold Stranger", "Old Fabio the Poor", 14, false )
		{
	...
	{
		[Constructable]
		public BurningOfTrinsic() : base( Utility.Random( 0xFEF, 2 ), "The Burning of Trinsic", "Japheth of Trinsic", 23, false )
		{
	...
	{
		[Constructable]
		public TheFight() : base( Utility.Random( 0xFEF, 2 ), "The Fight", "M. de la Garza", 13, false )
		{
	...
	{
		[Constructable]
		public LifeOfATravellingMinstrel() : base( Utility.Random( 0xFEF, 2 ), "The Life of a Travelling Minstrel", "Sarah of Yew", 18, false )
		{
	...
	{
		[Constructable]
		public MajorTradeAssociation() : base( Utility.Random( 0xFEF, 2 ), "The Major Trade Associations", "Pieter of Vesper", 18, false )
		{
	...
	{
		[Constructable]
		public RankingsOfTrades() : base( Utility.Random( 0xFEF, 2 ), "The Rankings of Trades", "Lord Higginbotham", 9, false )
		{
	...
	{
		[Constructable]
		public WildGirlOfTheForest() : base( Utility.Random( 0xFEF, 2 ), "The Wild Girl of the Forest", "Horace the Trader", 16, false )
		{
	...
	{
		[Constructable]
		public TreatiseOnAlchemy() : base( Utility.Random( 0xFEF, 2 ), "Treatise on Alchemy", "Felicia Hierophant", 12, false )
		{
	...
	{
		[Constructable]
		public VirtueBook() : base( Utility.Random( 0xFEF, 2 ), "Virtue", "Lord British", 20, false )
		{
