...
namespace Server.Items
{
	public abstract class LockableContainer : TrapableContainer, ILockable, ILockpickable, ICraftable //, ITelekinesisable
	{
		...
		public Mobile Locker { get { return m_Locker; } set { m_Locker = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public Mobile Picker { get { return m_Picker; } set { m_Picker = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int MaxLockLevel { get { return m_MaxLockLevel; } set { m_MaxLockLevel = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int LockLevel { get { return m_LockLevel; } set { m_LockLevel = value; } }

		[CommandProperty( AccessLevel.GameMaster )]
		public int RequiredSkill { get { return m_RequiredSkill; } set { m_RequiredSkill = value; } }
		...
		public virtual bool Locked
		{
			...
			set
			{
				...
				if ( m_Locked )
				{
					...
					if ( !Enabled && m_Locker != null )
					{
						Enabled = true;

						SendLocalizedMessageTo( m_Locker, 501673 ); // You re-enable the trap.						
					}
				}
				else
				{
					if ( Enabled && m_Locker != null )
					{
						...
						SendLocalizedMessageTo( m_Locker, 501672 ); // You disable the trap temporarily.  Lock it again to re-enable it.
					}
				}
