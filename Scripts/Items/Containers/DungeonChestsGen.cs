...
namespace Server.Items
{
	public class DungeonChestsSpawner : Item
	{
		...
		{
			Commands.Register( "ChestsGenerate", AccessLevel.Administrator, new CommandEventHandler( ChestsGenerate_OnCommand ) );
			Commands.Register( "ChestsDelete", AccessLevel.Administrator, new CommandEventHandler( ChestsDelete_OnCommand ) );
		}
		...
		public class ChestInstance
		{
			...
			public ChestInstance( ChestEntry entry ) : this( entry, null, DateTime.Now )
			{
			}
		...
		private DungeonChestsSpawner() : base( 1 )
		{
		...
		public DungeonChestsSpawner( Serial serial ) : base( serial )
		{
			m_Instance = this;
		}
