...
namespace Server.Items
{
	...
	public class ConcussionBlow : WeaponAbility
	{
		...
		public override void OnHit( Mobile attacker, Mobile defender, int damage )
		{
			...
			int damage_new = 10;
			int current_damage = Math.Abs( defender.Hits - defender.Mana );
			int max_damage = Math.Abs( defender.HitsMax - defender.ManaMax );

			damage_new = Math.Max( current_damage, max_damage );
			...
			AOS.Damage( defender, attacker, damage_new, 100, 0, 0, 0, 0 );
		}
	}
}