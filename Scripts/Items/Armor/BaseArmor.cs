...
namespace Server.Items
{
	public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable
	{
		...
		public AMA MeditationAllowance { get { return (m_Meditate == (AMA) (-1) ? Core.AOS ? AosMedAllowance : OldMedAllowance : m_Meditate); } set { m_Meditate = value; } }
		...
		public double ArmorRatingScaled { get { return (ArmorRating*ArmorScalar); } }
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if ( !(this is BaseShield) && MeditationAllowance == ArmorMeditationAllowance.All && m_AosArmorAttributes.MageArmor != 0 )
			{
