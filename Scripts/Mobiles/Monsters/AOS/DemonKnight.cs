...
namespace Server.Mobiles
{
	...
	public class DemonKnight : BaseCreature
	{
		...
		public static void DistributeArtifact( Mobile to, Item artifact )
		{
			...
			{
				artifact.Cheater_Name = String.Format( "This item received by GM {0}", to.Name );
			}
			...
			if ( pack == null || !pack.TryDropItem( to, artifact, false ) )
			{
				...
				{
					to.SendLocalizedMessage( 1072523 ); // You find an artifact, but your backpack and bank are too full to hold it.
		...
		[Constructable]
		public DemonKnight() : base( AIType.AI_DemonKnight, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
