...
namespace Server.Mobiles
{
	public class CustomHairstylist : BaseVendor
	{
		...
		private static HairstylistBuyInfo[] m_SellList = new HairstylistBuyInfo[] {new HairstylistBuyInfo( 1018357, 50000, Layer.Hair, typeof( ChangeHairstyleGump ), new object[] {From, Vendor, Price, Layer.Hair, ChangeHairstyleEntry.HairEntries} ), new HairstylistBuyInfo( 1018358, 50000, Layer.FacialHair, typeof( ChangeHairstyleGump ), new object[] {From, Vendor, Price, Layer.FacialHair, ChangeHairstyleEntry.BeardEntries} ), new HairstylistBuyInfo( 1018359, 50, Layer.Hair, typeof( ChangeHairHueGump ), new object[] {From, Vendor, Price, new Layer[] {Layer.Hair, Layer.FacialHair}, ChangeHairHueEntry.RegularEntries} ), new HairstylistBuyInfo( 1018360, 500000, Layer.Hair, typeof( ChangeHairHueGump ), new object[] {From, Vendor, Price, new Layer[] {Layer.Hair, Layer.FacialHair}, ChangeHairHueEntry.BrightEntries} ), new HairstylistBuyInfo( 1018361, 30000, Layer.Hair, typeof( ChangeHairHueGump ), new object[] {From, Vendor, Price, new Layer[] {Layer.Hair}, ChangeHairHueEntry.RegularEntries} ), new HairstylistBuyInfo( 1018362, 30000, Layer.FacialHair, typeof( ChangeHairHueGump ), new object[] {From, Vendor, Price, new Layer[] {Layer.FacialHair}, ChangeHairHueEntry.RegularEntries} ), new HairstylistBuyInfo( 1018363, 500000, Layer.Hair, typeof( ChangeHairHueGump ), new object[] {From, Vendor, Price, new Layer[] {Layer.Hair}, ChangeHairHueEntry.BrightEntries} ), new HairstylistBuyInfo( 1018364, 500000, Layer.FacialHair, typeof( ChangeHairHueGump ), new object[] {From, Vendor, Price, new Layer[] {Layer.FacialHair}, ChangeHairHueEntry.BrightEntries} )};
	...
	public class ChangeHairHueEntry
	{
		...
		public static readonly ChangeHairHueEntry[] BrightEntries = new ChangeHairHueEntry[] {new ChangeHairHueEntry( "*****", 12, 10 ), new ChangeHairHueEntry( "*****", 32, 5 ), new ChangeHairHueEntry( "*****", 38, 8 ), new ChangeHairHueEntry( "*****", 54, 3 ), new ChangeHairHueEntry( "*****", 62, 10 ), new ChangeHairHueEntry( "*****", 81, 2 ), new ChangeHairHueEntry( "*****", 89, 2 ), new ChangeHairHueEntry( "*****", 1153, 2 )};

		public static readonly ChangeHairHueEntry[] RegularEntries = new ChangeHairHueEntry[] {new ChangeHairHueEntry( "*****", 1602, 26 ), new ChangeHairHueEntry( "*****", 1628, 27 ), new ChangeHairHueEntry( "*****", 1502, 32 ), new ChangeHairHueEntry( "*****", 1302, 32 ), new ChangeHairHueEntry( "*****", 1402, 32 ), new ChangeHairHueEntry( "*****", 1202, 24 ), new ChangeHairHueEntry( "*****", 2402, 29 ), new ChangeHairHueEntry( "*****", 2213, 6 ), new ChangeHairHueEntry( "*****", 1102, 8 ), new ChangeHairHueEntry( "*****", 1110, 8 ), new ChangeHairHueEntry( "*****", 1118, 16 ), new ChangeHairHueEntry( "*****", 1134, 16 )};
	}
	...
	public class ChangeHairstyleEntry
	{
		...
		public static readonly ChangeHairstyleEntry[] HairEntries = new ChangeHairstyleEntry[] {new ChangeHairstyleEntry( 50700, 70 - 137, 20 - 60, typeof( ShortHair ) ), new ChangeHairstyleEntry( 60710, 193 - 260, 18 - 60, typeof( PageboyHair ) ), new ChangeHairstyleEntry( 50703, 316 - 383, 25 - 60, typeof( Mohawk ) ), new ChangeHairstyleEntry( 60708, 70 - 137, 75 - 125, typeof( LongHair ) ), new ChangeHairstyleEntry( 60900, 193 - 260, 85 - 125, typeof( Afro ) ), new ChangeHairstyleEntry( 60713, 320 - 383, 85 - 125, typeof( KrisnaHair ) ), new ChangeHairstyleEntry( 60702, 70 - 137, 140 - 190, typeof( PonyTail ) ), new ChangeHairstyleEntry( 60707, 193 - 260, 140 - 190, typeof( TwoPigTails ) ), new ChangeHairstyleEntry( 60901, 315 - 383, 150 - 190, typeof( ReceedingHair ) ), new ChangeHairstyleEntry( 0, 0, 0, null )};

		public static readonly ChangeHairstyleEntry[] BeardEntries = new ChangeHairstyleEntry[] {new ChangeHairstyleEntry( 50800, 120 - 187, 30 - 80, typeof( Goatee ) ), new ChangeHairstyleEntry( 50904, 243 - 310, 33 - 80, typeof( MediumShortBeard ) ), new ChangeHairstyleEntry( 50906, 120 - 187, 100 - 150, typeof( Vandyke ) ), new ChangeHairstyleEntry( 50801, 243 - 310, 95 - 150, typeof( LongBeard ) ), new ChangeHairstyleEntry( 50802, 120 - 187, 173 - 220, typeof( ShortBeard ) ), new ChangeHairstyleEntry( 50905, 243 - 310, 165 - 220, typeof( MediumLongBeard ) ), new ChangeHairstyleEntry( 50808, 120 - 187, 242 - 290, typeof( Mustache ) ), new ChangeHairstyleEntry( 0, 0, 0, null )};
	}
	...
	public class ChangeHairstyleGump : Gump
	{
		...
		public ChangeHairstyleGump( Mobile from, Mobile vendor, int price, Layer layer, ChangeHairstyleEntry[] entries ) : base( 50, 50 )
		{
			...
			if ( layer == Layer.Hair )
			{
				// <center>New Hairstyle</center>
				AddHtmlLocalized( 50, 15, 350, 20, 1018353, false, false );
			} 
			else
			{
				// <center>New Beard</center>
				AddHtmlLocalized( 55, 15, 200, 20, 1018354, false, false );
			} 
